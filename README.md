...
| <kbd>Ctrl</kbd> + <kbd>h</kbd>      | Reset analysis                                                                                               | This reverts the analysis to what the engine returns after a normal query, removing any additional exploration.                                                                                                              |
...
| Drag and drop a file onto the window           | Load that game for review                                                            | Accepts `.sgf`, `.gib` and `.ngf`, dropped anywhere on the window. Uses the default load options.                                       |
